...
public final class NetworkHelper {
	...
	public static void updateTileEntityField(TileEntity te, String field) {
		try {
			if (NetworkManager_updateTileEntityField == null) NetworkManager_updateTileEntityField = Class.forName(getPackage() + ".platform.NetworkManager").getMethod("updateTileEntityField", TileEntity.class, String.class);
			
			NetworkManager_updateTileEntityField.invoke(null, te, field);
		} catch (Exception e) {
	...
	public static void initiateTileEntityEvent(TileEntity te, int event, boolean limitRange) {
		try {
			if (NetworkManager_initiateTileEntityEvent == null) NetworkManager_initiateTileEntityEvent = Class.forName(getPackage() + ".platform.NetworkManager").getMethod("initiateTileEntityEvent", TileEntity.class, Integer.TYPE, Boolean.TYPE);
	...
	public static void initiateItemEvent(EntityPlayer player, ItemStack itemStack, int event, boolean limitRange) {
		try {
			if (NetworkManager_initiateItemEvent == null) NetworkManager_initiateItemEvent = Class.forName(getPackage() + ".platform.NetworkManager").getMethod("initiateItemEvent", EntityPlayer.class, ItemStack.class, Integer.TYPE, Boolean.TYPE);
			
			NetworkManager_initiateItemEvent.invoke(null, player, itemStack, event, limitRange);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	}
	...
	public static void announceBlockUpdate(World world, int x, int y, int z) {
		try {
			if (NetworkManager_announceBlockUpdate == null) NetworkManager_announceBlockUpdate = Class.forName(getPackage() + ".platform.NetworkManager").getMethod("announceBlockUpdate", World.class, Integer.TYPE, Integer.TYPE, Integer.TYPE);
	...
	public static void requestInitialData(INetworkDataProvider dataProvider) {
		try {
			if (NetworkManager_requestInitialData == null) NetworkManager_requestInitialData = Class.forName(getPackage() + ".platform.NetworkManager").getMethod("requestInitialData", INetworkDataProvider.class);
			
			NetworkManager_requestInitialData.invoke(null, dataProvider);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	}
	...
	public static void initiateClientTileEntityEvent(TileEntity te, int event) {
		try {
			if (NetworkManager_initiateClientTileEntityEvent == null) NetworkManager_initiateClientTileEntityEvent = Class.forName(getPackage() + ".platform.NetworkManager").getMethod("initiateClientTileEntityEvent", TileEntity.class, Integer.TYPE);
			
			NetworkManager_initiateClientTileEntityEvent.invoke(null, te, event);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	}
	...
	public static void initiateClientItemEvent(ItemStack itemStack, int event) {
		try {
			if (NetworkManager_initiateClientItemEvent == null) NetworkManager_initiateClientItemEvent = Class.forName(getPackage() + ".platform.NetworkManager").getMethod("initiateClientItemEvent", ItemStack.class, Integer.TYPE);
			
			NetworkManager_initiateClientItemEvent.invoke(null, itemStack, event);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	}
